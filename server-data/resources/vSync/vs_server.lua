...
function RandomTime()
    ...
    timeHour = math.random(0, 23)
    timeMinute = math.random(0, 59)
    ShiftToMinute(timeMinute)
    ShiftToHour(timeHour)
    TriggerClientEvent('vSync:notify', -1, 'Random Time: ' .. timeHour .. ':' .. timeMinute )
    TriggerEvent('vSync:requestSync')
end

function RandomWeather()
    possibleWeather = {'clear', 'smog', 'foggy', 'overcast', 'clouds', 'rain', 'thunder', 'xmas'}
